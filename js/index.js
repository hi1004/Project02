$(document).ready(function () {
    ...
    function sec2_switch(i) {
        $('.sec2_menu_wrap').find('li').eq(i).click(function () {
    ...
    function slider_switch(select_wrap) {
        $(select_wrap).find('span').each(function (index) {
            $(this).attr('data-index', index);
        }).click(function () {
            ...
            $('.slide_full_wrap').addClass('slide_full_active').siblings().removeClass('slide_full_active');
